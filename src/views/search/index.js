...
import { SET_CVE_DATA, SET_PRODUCT_DATA } from 'store/actions';
import { searchCVE } from 'api/cveApi';
import { searchProduct } from 'api/productApi';

const SearchBar = ({ data, type, setLoading, setTotal, isFromViewAll }) => {
    ...
    return (
        <Grid container>
            ...
            <Grid item xs={12}>
                <Button variant="contained" style={{ margin: '5px' }} onClick={onSearch}>
                    Search
                </Button>
            </Grid>
        </Grid>
